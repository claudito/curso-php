<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="navbar-nav ml-md-auto">
						<li class="nav-item active">
							 <a class="nav-link" href="#"><i class="fa fa-user text-success"></i> <span 
							 	 class="usuario-session"></span> <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item dropdown">
...
$(document).ready(function(){
 ...
 $.getJSON('sources/nav.php?op=1',{},function(data){
  ...
  $('.usuario-session').html(data.usuario);
...
$(document).on('click','.cerrar-sesion',function(){
 ...
 $.getJSON('sources/nav.php?op=2',{},function(data){
